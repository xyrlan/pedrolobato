...
import { DiagramKey, renderDiagram } from "./diagrams";
    ...
    <main className="min-h-[70vh]">
      <section className="w-full grid grid-cols-12 grid-gap relative z-10 max-w-[1800px]">
        <motion.div
          ...
          viewport={{ once: true }}
          className="select-none relative overflow-hidden my-2 md:my-8 h-[60vh] md:h-[49vh] object-cover w-full grid col-span-12 border border-ink/12">
        ...
        <div className="col-span-full md:col-end-4 md:top-[5em] text-ink md:sticky">
          <h1 className="mb-1 h1">{data.title}</h1>
          <p className="caption text-ink/62">{data.description}</p>
        </div>
        ...
        <div className="col-start-1 col-end-7 md:col-start-5 md:col-end-7 md:mb-8">
          <p className="text-ink/52 caption">ROLE</p>
        ...
        <div className="col-start-7 col-end-13 md:col-start-7 md:col-end-9 md:mb-8">
          <p className="text-ink/52 caption">TOOLS</p>
        ...
        <div className="col-start-1 col-end-7 mb-8 md:col-start-9 md:col-end-11">
          <p className="text-ink/52 caption">DURATION</p>
          <p className="body">
            {data.duration}
          </p>
        </div>
        {data.integrations && (
          <div className="col-start-7 col-end-13 mb-8 md:col-start-11 md:col-end-13">
            <p className="text-ink/52 caption">INTEGRATIONS</p>
        ...
        {data.collaborators && (
          <div className="col-start-7 col-end-13 mb-8 md:col-start-11 md:col-end-13">
            <p className="text-ink/52 caption">COLLABORATORS</p>
        ...
        {data.links && data.links.map((link: { name: string; url: string; icon: string }) => (
          <Link className=" md:col-start-5 md:col-end-9 select-none caption group text-ink/90 bg-ink/[.05] col-span-full hover:bg-ink/10 hover:text-ink flex items-center flex-row p-4 rounded-md game-border" key={link.name} href={link.url}>
            <p className="body">{link.icon}</p>
            <p className="body">{link.name}</p>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="h-3 w-3 ml-auto stroke-[3px] stroke-ink/30 group-hover:stroke-ink"><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5"></path></svg>
          </Link>
        ))}
        {data.features && data.features.map((feature: { title: string; description: string; description2?: string; description3?: string; visual?: DiagramKey; images?: { url: string; description: string }[] }) => (
          <React.Fragment key={feature.title}>
            ...
            {feature.visual && (
              <div className="grid-gap col-start-1 col-end-13 mb-4 md:col-start-5 md:col-end-13 lg:col-end-12">
                {renderDiagram(feature.visual)}
              </div>
            )}
           ...
           bg-ink/5 md:col-start-5 border-solid border-ink/12 border 
"
                >
                  {image.url.includes(".mp4") ? (
                    <div className="group relative h-auto overflow-hidden undefined">
                      <div className="caption absolute top-0 w-full h-full overflow-hidden opacity-0 bg-[rgba(255,255,255,0)]">
                        <p className="text-ink/62 flex h-full justify-center items-center">fabricating image</p>
                      </div>
                ...
                <div className="grid-gap col-start-1 col-end-13 mb-2 text-ink/50 md:col-start-5 md:col-end-13 lg:col-end-12">
